...
> 결론: ESG 우수기업 포트폴리오의 성공적인 초과수익률 달성에 영향을 미친 것은 ESG Index가 아니라, ESG score가 우수한 기업의 높은 시가총액(=기업 규모), 즉 기업이 ESG라는 비재무적 요소에 투자할 만큼의 여력이 충분했기 때문에 수익률도 높고 ESG score 또한 높았을 것이라는 시사점 도출.
